...
const localRequested = process.argv.includes("--local") || /^(1|true|yes)$/i.test(process.env.PIPA_VOICE_SESSION_LOCAL || "");
const explicitHostedRequested = process.argv.includes("--hosted") || /^(1|true|yes)$/i.test(process.env.PIPA_VOICE_SESSION_HOSTED || "");
