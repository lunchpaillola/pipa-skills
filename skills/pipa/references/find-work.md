...
Use when leads, signals, ideas, referrals, inbound messages, or prospect notes need next opportunity action.
...
- `references/initiate-problem-framing.md`: buyer pain + why now.
- `references/initiate-stakeholder-map.md`: buyer/influencer/decision-maker.
- `references/plan-roadmap-and-prioritization.md`: rank multiple next moves.
- `references/monitor-ticket-triage.md`: inbound response priority.
