...
# Pipa Monitor Ticket Triage Reference
...
Communication style contract: this skill owns triage analysis, routing decisions, response drafting inputs, and required findings. `references/communication-style.md` owns the final presentation of any user-facing answer.
...
After triage, hand the findings to `references/communication-style.md` for presentation.
