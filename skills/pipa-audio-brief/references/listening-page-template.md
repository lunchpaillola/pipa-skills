...
- The Settings popover should include a voice selector that prefers Daniel (`en-GB`) when available, then English Chrome/Google voices, then other natural/enhanced English voices, then the browser default.
